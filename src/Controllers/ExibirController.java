...
public final class ExibirController implements ActionListener {
	static private ExibirController INSTANCE;
	...
	public ExibirController(JTable table) throws SQLException {
        ...
        public static ExibirController getInstance(JTable table) throws SQLException{
            INSTANCE = new ExibirController(table);
